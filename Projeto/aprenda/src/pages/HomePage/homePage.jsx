...
const HomePage = () => {
      ...
      <section className={styles.baner}>
        <div className={styles.banerContainer}>
          <div className={styles.banerTexto}>
            ...
            <p>Encontre pessoas reais que querem aprender e ensinar, como você.</p>
  ...
  <div className={styles.sobreContainer}>
    ...
    <div className={styles.sobreTexto}>
      ...
      <p>
        Unimos pessoas que querem aprender e ensinar, criando conexões reais e
      ...
      <section className={styles.beneficios}>
        ...
        <p>Facilitamos o aprendizado com conexões reais e experiências únicas.</p>
        <div className={styles.cards}>
          <div className={styles.card}>
            <h3>Aprenda mais rápido</h3>
            <p>
              Encontre quem compartilha sua paixão e evolua através da troca de
              experiências.
            </p>
          </div>
          <div className={styles.card}>
            ...
            <p>
              Faça parcerias duradouras com pessoas que têm sede de aprender como
              você.
            </p>
          </div>
          <div className={styles.card}>
            <h3>Sem barreiras</h3>
            <p>
              Tudo o que você precisa para crescer está a um clique de distância,
              sem burocracias.
            </p>
          </div>
        </div>
        <button className={styles.banerBotao}>Participe</button>
      </section>

      {/* Como Funciona */}
      <section className={styles.funciona}>
        <h2>Como Funciona?</h2>
        <p>Entenda o passo a passo da nossa plataforma.</p>
        <div className={styles.etapas}>
          <div>
            <h3>1. Crie sua conta</h3>
            <p>
              Faça seu cadastro e personalize seu perfil com suas habilidades e o
              que deseja aprender.
            </p>
          </div>
          <div>
            <h3>2. Encontre parceiros</h3>
            <p>
              Receba sugestões de pessoas com interesses compatíveis para trocar
              conhecimento.
            </p>
          </div>
          <div>
            <h3>3. Conecte e aprenda</h3>
            <p>
              Marque sessões, troque experiências e evoluam juntos.
            </p>
          </div>
        </div>
      </section>
